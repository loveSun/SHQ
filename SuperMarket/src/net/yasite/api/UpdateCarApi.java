...
public class UpdateCarApi extends BaseAPI {

	public UpdateCarApi(Context context, List<NameValuePair> pm,
			UserInfoParam params) {
		super(context, pm, params);
		// TODO Auto-generated constructor stub
		setMethod("http://www.yasite.net/shopapi/index.php/cartController/updateCart/"+params.getToken());
	}
