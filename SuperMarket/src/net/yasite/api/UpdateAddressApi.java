...
public class UpdateAddressApi extends BaseAPI {
	...
	public UpdateAddressApi(Context context, List<NameValuePair> pm,
			UserInfoParam params) {
		super(context, pm, params);
		// TODO Auto-generated constructor stub
		setMethod("http://www.yasite.net/shopapi/index.php/userController/updateAddress/"+params.getToken());
