...
public class UpdateUserInfoApi extends BaseAPI {
	...
	public UpdateUserInfoApi(Context context, List<NameValuePair> pm,
			UserInfoParam params) {
		super(context, pm, params);
		// TODO Auto-generated constructor stub
		setMethod("http://www.yasite.net/shopapi/index.php/userController/updateUserInfo/"+params.getToken());
	}
